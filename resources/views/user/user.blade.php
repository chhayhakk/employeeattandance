                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                {{-- <a href="{{ url('/admin/index_edit_user') }}">
                                    <button type="button" style="font-family: Kantumruy Pro; border-color: #397a89; border-radius: 4px; padding:5px 5px;color:#397a89">
                                        <i class="fas fa-edit" style=" color: #2b89a3;"></i>
                                        កែប្រែ
                                    </button>
                                </a>
                                <a href="{{ url('routes/admin/user.php') }}">
                                    <button type="button" style="font-family: Kantumruy Pro; border-color: #a71e23; border-radius: 5px; padding:5px 5px;color:#a71e23">
                                        <i class="fas fa-trash" style=" color:#a71e23;"></i>
                                        លុប
                                    </button>
                                </a> --}}
                                ...
                                <div style="position:relative; display:inline-block; float:right">
                                    <form class="d-flex" action="{{ route('search_users') }}" method="GET">
                                        <input class="form-control me-2" type="search" name="search" placeholder="ស្វែងរក" aria-label="Search" style="width: 400px; font-family: Kantumruy Pro">
                                        <button class="btn btn-outline-success" type="submit" style="margin-left: 8px; font-family: Kantumruy Pro">ស្វែងរក</button>
                                    </form>
                                            ...
                                            <form class="form-control">
                                                <tr style="border-radius:5px" >
                                                    ...
                                                    <td style="display:flex">
                                                            ...
                                                            class="main__table-btn main__table-btn--{{ $item->status == 'Blocked' ? 'banned' : 'approved' }}" 
